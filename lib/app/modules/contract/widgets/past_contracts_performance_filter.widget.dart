...
class PastContractsPerformanceFilter extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<PastContractPerformanceController>(builder: (controller) {
      return Container(
        ...
        child: Column(
          children: [
            ShadowBox(
              ...
              child: Row(
                children: [
                  Expanded(flex: 2, child: _buildCommodityItem(controller)),
                  VerticalDivider(
                    color: Colors.grey,
                    width: 2,
                    thickness: 1,
                  ...
                  Expanded(
                    flex: 2,
                    child: _buildDateItem(context, controller),
                  ),
  ...
  Widget _buildCommodityItem(PastContractPerformanceController controller) {
    return InkWell(
      onTap: () {
  ...
  Widget _buildDateItem(
      BuildContext context, PastContractPerformanceController controller) {
  ...
  Widget _buildAllSuppliesItem(PastContractPerformanceController controller) {
    return InkWell(
      onTap: () {
        Get.bottomSheet(
                ...
                ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return RadioListTile<int>(
                      ...
                      value: item.id,
                      groupValue: popUpController.filterParam.commodityTypeId,
  ...
  Widget _buildTimeFrame(PastContractPerformanceController controller) {
    return InkWell(
      onTap: () {
        Get.bottomSheet(_buildTimeFrameFilter());
      },
      child: Row(
        children: [
          Padding(
  ...
  Widget _buildContractType(PastContractPerformanceController controller) {
    return InkWell(
      onTap: () {
        Get.bottomSheet(_buildContractTypeFilter());
      },
      child: Row(
        children: [
          Padding(
