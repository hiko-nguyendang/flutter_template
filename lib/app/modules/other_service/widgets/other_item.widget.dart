                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    LocaleKeys.OtherServices_ProductName.tr,
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: kPrimaryBlackColor,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Text(
                                    LocaleKeys.OtherServices_ProductBrand.tr,
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: kPrimaryBlackColor,
                                      fontWeight: FontWeight.w400,
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    LocaleKeys.OtherServices_BagSize.tr,
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: kPrimaryBlackColor,
                                      fontWeight: FontWeight.w400,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      LocaleKeys.OtherServices_Composition.tr,
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: kPrimaryBlackColor,
                                        fontWeight: FontWeight.w400,
                            ...
                            Row(
                              ...
                              children: [
                                Expanded(
                                  child: Text(
                                    LocaleKeys.OtherServices_PriceDelivered.tr,
                                    style: TextStyle(
                                      fontSize: 14,
                                      color: kPrimaryBlackColor,
                                      fontWeight: FontWeight.w400,
                                ...
                                Text(
                                  '${NumberFormat('###,###.##').format(item.other.priceDelivered)} '
                                  '${item.other.currency}/'
                                  '${OtherServicePackingUnitEnum.getName(item.other.packingUnitTypeId)}',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: kPrimaryBlackColor,
                                    fontWeight: FontWeight.w600,
                            ...
                            Padding(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      LocaleKeys.OtherServices_PriceWithoutCredit.tr,
                                      style: TextStyle(
                                        fontSize: 14,
                                        color: kPrimaryBlackColor,
                                        fontWeight: FontWeight.w400,
                                  ...
                                  Text(
                                    '${NumberFormat('###,###.##').format(item.other.priceWithoutCredit)} '
                                        '${item.other.currency}/'
                                        '${OtherServicePackingUnitEnum.getName(item.other.packingUnitTypeId)}',
                                    style: TextStyle(
                                      fontSize: 14,
                ...
                if (item.comments != null && item.comments.isNotEmpty)
                  Padding(
                    ...
                    child: InkWell(
                      ...
                      child: RichText(
                        text: TextSpan(
                          text: LocaleKeys.OtherServices_ApplicationRecommendation.tr,
                          style: TextStyle(
                            fontSize: 14,
                            color: kPrimaryBlackColor,
                            fontWeight: FontWeight.w600,
