...
class PastContractsPriceFilter extends StatelessWidget {
  @override
  ...
  Widget _buildCommodityItem(PastContractPriceController controller) {
    return InkWell(
      onTap: () {
        Get.bottomSheet(
  ...
  Widget _buildDateItem(
      BuildContext context, PastContractPriceController controller) {
  ...
  Widget _buildAllSuppliesItem(PastContractPriceController controller) {
    return InkWell(
      onTap: () {
        Get.bottomSheet(
  ...
  Widget _buildTimeFrame(PastContractPriceController controller) {
    return InkWell(
      onTap: () {
  ...
  Widget _buildTimeFrameFilter() {
    return GetBuilder<PastContractPriceController>(builder: (popUpController) {
      return NotificationListener<OverscrollIndicatorNotification>(
        onNotification: (overScroll) {
          overScroll.disallowGlow();
          return;
  ...
  Widget _buildContractType(PastContractPriceController controller) {
    return InkWell(
      onTap: () {
  ...
  Widget _buildGrade(PastContractPriceController controller) {
    return InkWell(
      onTap: () {
